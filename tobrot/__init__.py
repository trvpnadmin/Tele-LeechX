...
APP_ID = getVar("APP_ID", None)
API_HASH = getVar("API_HASH", "")
OWNER_ID = getVar("OWNER_ID", "")
...
AUTH_CHANNEL = [x for x in getVar("AUTH_CHANNEL", "").split()]
SUDO_USERS = [sudos if (' ' not in getVar('SUDO_USERS', '')) else sudos for sudos in getVar('SUDO_USERS', '').split()]
